...
/*
  ...
  2. 配置指令
    "start": "webpack"
  3. 配置
    文档: https://webpack.docschina.org/loaders/postcss-loader/
    {
      ...
      options: {
        ...
        plugins: (loader) => [
          ...
          require("postcss-preset-env")(), // 包含了autoprefixer, 不用再单独配置它了
          require("cssnano")(),
        ],
      },
    },
    ...
    rules: [
      {
        ...
        use: [
          "style-loader", /* 将js中css转移到页面的<style></style> */
          "css-loader", /* 将css文件中css转移到js中 */
          // https://webpack.docschina.org/loaders/postcss-loader#plugins
          {
            loader: "postcss-loader", /* 将css文件中的css代码转换为兼容浏览器的版本 */
            options: {
              ident: "postcss",
              plugins: (loader) => [
                require("postcss-import")({ root: loader.resourcePath }),
